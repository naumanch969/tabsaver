  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 h-full bg-[#1e1e1e] text-white">
      <div className="relative mb-8 pt-4">
        <div className="w-20 h-20 bg-linear-to-br from-[#e8a84b] to-[#c98e3b] rounded-2xl flex items-center justify-center shadow-2xl shadow-yellow-500/10 rotate-3 group-hover:rotate-6 transition-transform">
      ...
      <div className="w-full space-y-3">
        ...
        >
          <LogIn size={18} />
          <span>Sign in at tabstack.app</span>
        </button>
